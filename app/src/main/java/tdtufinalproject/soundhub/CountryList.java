...
public class CountryList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.country_view);
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.country_bottom);
