...
public class RockList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.rock_view);
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.rock_bottom);
