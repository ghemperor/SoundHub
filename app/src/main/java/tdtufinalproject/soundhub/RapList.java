...
public class RapList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rap_list);

        ConstraintLayout constraintLayout = findViewById(R.id.rap_view);
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.rap_bottom);
