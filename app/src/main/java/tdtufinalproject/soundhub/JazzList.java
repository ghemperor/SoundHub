...
public class JazzList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jazz_list);
        ConstraintLayout constraintLayout = findViewById(R.id.jazz_view);
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.jazz_bottom);
