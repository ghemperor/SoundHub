...
public class PopList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.pop_view);
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.pop_bottom);
